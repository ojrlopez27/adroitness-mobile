...
//            startService(wearClient);
    ...
    public static void stopPlugin( Context context, String package_name ) {
        ...
        Intent core = new Intent( context, Aware.class );
    ...
    public static class PluginMonitor extends BroadcastReceiver {
    	...
    	public void onReceive(Context context, Intent intent) {
            ...
            if( intent.getAction().equals(Intent.ACTION_PACKAGE_ADDED) ) {
                ...
                //Installing new
                try {
                    ApplicationInfo appInfo = mPkgManager.getApplicationInfo( packageName, PackageManager.GET_META_DATA); //PackageManager.GET_ACTIVITIES );
